 ...
 * 
 */
@WebServiceClient(name = "Calculator", targetNamespace = "http://www.example.org/Calculator/", wsdlLocation = "file:/C:/Users/Qba/Documents/STUDIA/rozprochy/zadania/zad5/Ex6/Calculator.wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATOR_QNAME = new QName("http://www.example.org/Calculator/", "Calculator");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/C:/Users/Qba/Documents/STUDIA/rozprochy/zadania/zad5/Ex6/Calculator.wsdl");
    ...
    public Calculator getCalculatorSOAP() {
        return super.getPort(new QName("http://www.example.org/Calculator/", "CalculatorSOAP"), Calculator.class);
    }
    ...
    public Calculator getCalculatorSOAP(WebServiceFeature... features) {
        return super.getPort(new QName("http://www.example.org/Calculator/", "CalculatorSOAP"), Calculator.class, features);
    }
