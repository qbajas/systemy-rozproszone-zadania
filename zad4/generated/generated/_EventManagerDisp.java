...
// <auto-generated>
//
// Generated from file `_EventManagerDisp.java'
//
...
public abstract class _EventManagerDisp extends Ice.ObjectImpl implements EventManager
{
    protected void
    ...
    ___createEvent(EventManager __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
    ...
    public static Ice.DispatchStatus
    ___subscribe(EventManager __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        IceInternal.BasicStream __is = __inS.is();
        __is.startReadEncaps();
    ...
    public static Ice.DispatchStatus
    ___listEvents(EventManager __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
    ...
    public static Ice.DispatchStatus
    ___modify(EventManager __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        IceInternal.BasicStream __is = __inS.is();
        __is.startReadEncaps();
    ...
    __dispatch(IceInternal.Incoming in, Ice.Current __current)
    {
        ...
        switch(pos)
        {
            case 0:
            {
                return ___createEvent(this, in, __current);
            }
            case 1:
            {
    ...
    __write(Ice.OutputStream __outS)
    {
        ...
        ex.reason = "type generated::EventManager was not generated with stream support";
        throw ex;
    }
